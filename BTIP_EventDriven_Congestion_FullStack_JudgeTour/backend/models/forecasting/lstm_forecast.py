...
def _configure_torch_runtime(torch_module):
    """Prevent CPU thread oversubscription during single-sample inference."""
    ...
    try:
        ...
        # Inter-op threads can only be configured before the first parallel op.
        pass
